...
_vehicle addWeaponCargoGlobal ["rhs_weap_m4a1_carryhandle_grip2", 1];
_vehicle addMagazineCargoGlobal ["rhs_mag_30Rnd_556x45_M855A1_Stanag", 10];
_vehicle addMagazineCargoGlobal ["rhsusf_100Rnd_556x45_soft_pouch", 2];
_vehicle addMagazineCargoGlobal ["rhsusf_100Rnd_762x51", 2];
